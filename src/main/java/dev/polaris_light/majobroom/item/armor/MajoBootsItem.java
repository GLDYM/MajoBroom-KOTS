...
public class MajoBootsItem extends ArmorItem implements GeoItem {
    ...
    private static final UUID ARMOR_UUID = UUID.fromString("86ec1dd8-8f2d-4a76-a871-40f88d4ba8ed");
    private static final UUID TOUGHNESS_UUID = UUID.fromString("0429f0f0-490a-4bbd-bb10-d1a0ba2fb9d0");
    private static final UUID SPELL_RESIST_UUID = UUID.fromString("30d30f9a-cb7a-4a12-9264-7f9dd6a7e5f1");

    public MajoBootsItem(Properties properties) {
        super(MajoArmorMaterials.MAJO, ArmorItem.Type.BOOTS, properties);
    }
    ...
    public int getDefense() {
        return ServerConfig.armorOverpower ? 5 : this.material.getDefenseForType(this.type);
    }
    ...
    public Multimap<Attribute, AttributeModifier> getDefaultAttributeModifiers(EquipmentSlot slot) {
        ...
        builder.put(
            ...
            new AttributeModifier(
                ARMOR_UUID,
                MajoBroom.MODID + ":majo_boots_armor",
                ServerConfig.armorOverpower ? 5.0D : this.getDefense(),
        ...
        builder.put(
            ...
            new AttributeModifier(
                TOUGHNESS_UUID,
                MajoBroom.MODID + ":majo_boots_toughness",
        ...
        if (spellResist != null) {
            builder.put(
                ...
                new AttributeModifier(
                    SPELL_RESIST_UUID,
                    MajoBroom.MODID + ":majo_boots_spell_resist",
